...
<body>
    <div class="ui basic segment container" id="luar">
        ...
        <form class="ui segment form" method="post" action="api/api_login.php">
            <div class="field">
            ...
            <a class="ui right floated button yellow" id="btn-sign-up" href="signup.php">Sign Up</a>
        </form>
    </div>
</body>
<script src="jquery-3.7.0.min.js"></script>
<scrip src="semantic/Semantic-UI-CSS-master/semantic.min.js">
    </script>
